...
var charts = 
{
	...
	traffic_sources_pie: 
	{
		// data
		data: [
			{ label: "Install Complete",  data: 47 },
			{ label: "Needs Tech Support",  data: 3 },
			{ label: "Yet to ship",  data: 50 }
		],
    ...
    this.data.d1 = [[1, 0], [2, 20], [3, 80], [4, 90],[5, 100],[6, 100]];
    this.data.d2 = [[9, 0],[10, 10],[11, 20],[12, 30],[13,40],[14, 50],[15,60],[16, 75],[17, 85],[21, 90],[22, 95],[23, 100]];
    ...
    this.data.d4 = [[9, 0],[23, 100]];
			...
			//this.data.d2 = [[1, 6], [2, charts.utility.randNum()-4], [3, charts.utility.randNum()-4], [4, charts.utility.randNum()],[5, 4+charts.utility.randNum()],[6, 4+charts.utility.randNum()],[7, 5+charts.utility.randNum()],[8, 5+charts.utility.randNum()],[9, 6+charts.utility.randNum()],[10, 6+charts.utility.randNum()],[11, 6+charts.utility.randNum()],[12, 2+charts.utility.randNum()],[13, 3+charts.utility.randNum()],[14, 4+charts.utility.randNum()],[15, 4+charts.utility.randNum()],[16, 4+charts.utility.randNum()],[17, 5+charts.utility.randNum()],[18, 5+charts.utility.randNum()],[19, 2+charts.utility.randNum()],[20, 2+charts.utility.randNum()],[21, 3+charts.utility.randNum()],[22, 3+charts.utility.randNum()],[23, 3+charts.utility.randNum()],[24, 2+charts.utility.randNum()],[25, 4+charts.utility.randNum()],[26, 4+charts.utility.randNum()],[27,5+charts.utility.randNum()],[28, 2+charts.utility.randNum()],[29, 2+charts.utility.randNum()], [30, 3+charts.utility.randNum()]];
           		// this.data.d3 = [[1, charts.utility.randNum()-7], [3, charts.utility.randNum()-4], [3, charts.utility.randNum()-6], [4, charts.utility.randNum()],[5, 4+charts.utility.randNum()],[6, 3+charts.utility.randNum()],[7, 5+charts.utility.randNum()],[8, 5+charts.utility.randNum()],[9, 4+charts.utility.randNum()],[10, 6+charts.utility.randNum()],[11, 6+charts.utility.randNum()],[12, 1+charts.utility.randNum()],[13, 3+charts.utility.randNum()],[14, 4+charts.utility.randNum()],[15, 4+charts.utility.randNum()],[16, 4+charts.utility.randNum()],[17, 5+charts.utility.randNum()],[18, 5+charts.utility.randNum()],[19, 2+charts.utility.randNum()],[20, 2+charts.utility.randNum()],[21, 3+charts.utility.randNum()],[22, 3+charts.utility.randNum()],[23, 3+charts.utility.randNum()],[24, 2+charts.utility.randNum()],[25, 4+charts.utility.randNum()],[26, 4+charts.utility.randNum()],[27,5+charts.utility.randNum()],[28, 2+charts.utility.randNum()],[29, 2+charts.utility.randNum()], [30, 3+charts.utility.randNum()]];
			...
			lplot = $.plot(
				 ...
				 },
				{
         			...
         			data: this.data.d3,
				color:"rgba(0,0,0,0)",
         			lines: {fillColor: "#fefefe", fill: false},
         			...
         			data: this.data.d1,
				color:"#ffffff",
         			lines: {fillColor: "#ffffff", fill: false},
         			points: {fillColor: "#88bbc8"}
         			},
 				{
         			label: "", 
				...
				color:"#ffffff",
         			...
         			},
 				{
         			...
         			data: this.data.d4,
				color:"#ff0000",
         			lines: {fillColor: "#ff0000", fill: false},
         			points: {fillColor: "#88bbc8"}
         			}
	...
	chart_ordered_bars:
	{
		...
		init: function()
		{
		    ...
		    ds.push({
		     	label: "Display Present & Functioning",
		        data:d1,
		        bars: {order: 1}
		    });
		    ds.push({
		    ...
		    ds.push({
		    	label: "",
		        data:d4,
		        bars: {order: 4, show:false}
		    });
		    ds.push({
		    	label: "Assets Present & Functioning",
		        data:d5,
		        bars: {order: 5}
		    });
			this.data = ds;
