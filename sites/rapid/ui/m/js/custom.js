...
jQuery(document).ready(function($){
	...
	if(topNotification == true){
		...
		$('.topNotification').stop(true, true).delay(1000).animate({height:'show'}, 500, 'easeOutCubic', function(){})
	
	};
	
	$('.notificationButton').click(function(){
		
		$(this).parent().stop(true, true).animate({height:'hide'}, 500, 'easeOutCubic', function(){});
